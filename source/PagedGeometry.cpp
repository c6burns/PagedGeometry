...
void PagedGeometry::update()
{
	...
	if (pageLoader != 0){
		...
		for (it = managerList.begin(); it != managerList.end(); ++it){
			...
			prevMgr = mgr;
			gmnum++;
			//LogManager::getSingleton().logMessage("PagedGeometry::update::update(): " + Ogre::StringConverter::toString(t1.getMicroseconds()));
			t1.reset();
		}
	}
	...
	//LogManager::getSingleton().logMessage("PagedGeometry::update::updateall(): " + Ogre::StringConverter::toString(t1.getMicroseconds()));
	//LogManager::getSingleton().logMessage("PagedGeometry::update: " + Ogre::StringConverter::toString(t2.getMicroseconds()));
}
